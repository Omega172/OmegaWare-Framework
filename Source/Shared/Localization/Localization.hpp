...
public:
	...
	// Needs private access to load locales directly onto the instance being constructed,
	// bypassing GetInstance() - see the comment on RegisterLocales() in Locales.hpp for why.
	friend void RegisterLocales(Localization& self);
