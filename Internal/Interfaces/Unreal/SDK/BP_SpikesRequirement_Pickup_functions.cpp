...
#include "BP_SpikesRequirement_Pickup_classes.hpp"
#include "BP_SpikesRequirement_Pickup_parameters.hpp"
...
bool UBP_SpikesRequirement_Pickup_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SpikesRequirement_Pickup_C", "BP_CheckRequirement");

	Params::BP_SpikesRequirement_Pickup_C_BP_CheckRequirement Parms{};
