...
// Package: BP_Fingerprint_Requirement

#include "Basic.hpp"

#include "BP_Fingerprint_Requirement_classes.hpp"
#include "BP_Fingerprint_Requirement_parameters.hpp"


namespace SDK
{

// Function BP_Fingerprint_Requirement.BP_Fingerprint_Requirement_C.BP_CheckRequirement
...
bool UBP_Fingerprint_Requirement_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Fingerprint_Requirement_C", "BP_CheckRequirement");

	Params::BP_Fingerprint_Requirement_C_BP_CheckRequirement Parms{};
