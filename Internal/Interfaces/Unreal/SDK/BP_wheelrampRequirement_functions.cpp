...
#include "BP_wheelrampRequirement_classes.hpp"
#include "BP_wheelrampRequirement_parameters.hpp"


namespace SDK
{

// Function BP_wheelrampRequirement.BP_wheelrampRequirement_C.BP_CheckRequirement
...
bool UBP_wheelrampRequirement_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_wheelrampRequirement_C", "BP_CheckRequirement");

	Params::BP_wheelrampRequirement_C_BP_CheckRequirement Parms{};
